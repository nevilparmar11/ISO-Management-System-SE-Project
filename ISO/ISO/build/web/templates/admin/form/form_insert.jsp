        ...
        <form action="/ISO/admin/form/insert" method="POST">
            <table class="table">
                <tr class="row">
                    ...
                    <td><input class="form-control" type="number" name="document_no"></td>
                </tr> 
                <tr class="row">
                ...
                <tr class="row">
                    <td width="40%" class="col-form-label">Department</td>
                    <td class="dropdown">
                ...
                <td><input class="form-control" type="date" name="starting_plan"></td>
                </tr>
                <tr class="row">
                    <td width="40%">Ending Teaching Plan</td>
                    <td><input class="form-control" type="date" name="ending_plan"></td>
                </tr>
            </table>
            <br>
